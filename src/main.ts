...
function ret_string(Auth_book:AuthoredBook):string{
  ...
  console.log(text)
  const a:string='the name of author is '+ Auth_book.name+  "\nthe title of book is "+ Auth_book.title+
...
function add_day(your_day:string,start_time:number,end_time:number):LibrarySchedule{
...
function add_book(y_isbn:string,title:string,author:string,copies:number){
...
function swapping(array1:any[],item1:any,item2:any):any{//item 1 and 2 are to be swapped
